...
const DailyQuizScreen = ({ onBack, onOpenResults, isDarkMode = true, language = 'English' }) => {
  ...
  const headerTitleText = "Daily Quiz";
  const heroLabelText = "Today's challenge";
  const heroTitleText = "Daily quiz resets every day";
  const questionsCountText = "How many questions?";
  const durationText = "How long to practice?";
  const generateQuizText = "Generate today's quiz";
        ...
        <View style={[styles.heroCard, { backgroundColor: cardBg, borderColor: borderStyle }]}>
          ...
          <View style={styles.heroStatsRow}>
            <View style={styles.progressPill}>
              <Text style={styles.progressPillText}>{dailyQuestions.length} questions</Text>
            </View>
            <View style={[styles.progressPillAlt, { backgroundColor: pillBg }]}>
              <Text style={[styles.progressPillTextAlt, { color: textPrimary }]}>{practiceMinutes} min practice</Text>
            </View>
            <View style={[styles.progressPillAlt, { backgroundColor: pillBg }]}>
              <Text style={[styles.progressPillTextAlt, { color: textPrimary }]}>Score {getScoreLabel()}</Text>
            </View>
          </View>
