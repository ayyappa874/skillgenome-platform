        ...
        <Animated.View style={[S.card, { backgroundColor: T.surface, borderColor: T.border, opacity: fade, transform: [{ translateY: slide }] }, T.cardShadow]}>
          ...
          <View style={[S.typeToggle, { backgroundColor: T.surface2, borderColor: T.borderLow }]}>
            ...
            <Pressable
              ...
              style={[S.typeOption, userType === "admin" && { backgroundColor: T.accent }]}
            >
              <Text style={[S.typeText, { color: userType === "admin" ? "#fff" : T.muted }]}>
                🛡️ Admin
              </Text>
            </Pressable>
          </View>
          ...
          {/* Mentor Verification section (Appears cleanly below password fields) */}
          {userType === "mentor" && (
          ...
          <Pressable onPress={() => setTermsAccepted(!termsAccepted)} style={S.termsRow}>
            ...
            <Text style={[S.termsText, { color: T.muted }]}>
              ...
              <Text 
                ...
                onPress={() => { setShowTermsModal(true); setTermsTab("terms"); }}
              >
                Terms of Service
              </Text>
              {" "}and{" "}
              <Text 
                style={{ color: T.accent, fontWeight: "700" }} 
                onPress={() => { setShowTermsModal(true); setTermsTab("privacy"); }}
              >
                Privacy Policy
              </Text>
            </Text>
...
const getStyles = (T) => StyleSheet.create({
  root:          { flex: 1 },
  scrollContent: { flexGrow: 1, justifyContent: "flex-start", alignItems: "center", paddingTop: 80, paddingBottom: 60, paddingHorizontal: 20 },
  card: {
    width: "100%", maxWidth: 440, borderRadius: 24, borderWidth: 1,
    padding: 24, gap: 16, marginTop: 0,
  },
