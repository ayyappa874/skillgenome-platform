        ...
        <Animated.View style={{ opacity: fade, transform: [{ translateY: slide }], gap: 20 }}>
          ...
          <View style={[S.card, { borderColor: T.border, flexDirection: "row", alignItems: "center", padding: 16 }]}>
            ...
            <View style={S.fileInfo}>
              ...
              <Text style={S.fileSub}>{analysisData?.candidateName || "Ayyappa"} · {expYears} yrs experience</Text>
            </View>
...
const S = StyleSheet.create({
  ...
  scoreRingBg: { width: "100%", height: "100%", borderRadius: 62, backgroundColor: "#0f0f11", alignItems: "center", justifyContent: "center" },
