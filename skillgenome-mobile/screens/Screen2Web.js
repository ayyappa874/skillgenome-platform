      ...
      <style>{`
        ...
        *{margin:0;padding:0;box-sizing:border-box;}
        ...
        .btn-primary{
          ...
          font-family:'Inter',sans-serif; font-weight:700; font-size:16.5px; color:#fff;
          ...
          animation: gradientFlow 4s ease infinite, ctaPulse 2.4s ease-in-out infinite;
        ...
        @keyframes ctaPulse{
          0%, 100%{ transform: scale(1); box-shadow: 0 10px 30px rgba(121,40,202,0.4); }
          50%{ transform: scale(1.05); box-shadow: 0 16px 45px rgba(121,40,202,0.6); }
        }
        .btn-primary:hover{transform:translateY(-2px) scale(1.05); box-shadow:0 16px 45px rgba(121,40,202,0.5);}
        .btn-primary .shine{
