...
const Screen29 = ({ onBack, post = defaultPost, onAddComment, onLoadComments, onDeletePost, onLikePost, currentUser = "You", userId, isDarkMode = true, language = 'English' }) => {
          ...
          <View style={styles.authorMain}>
            ...
            <View style={styles.authorTagRow}>
              ...
              <View style={{ backgroundColor: isDarkMode ? "rgba(255, 255, 255, 0.1)" : "rgba(0, 0, 0, 0.05)", paddingHorizontal: 10, paddingVertical: 6, borderRadius: 999 }}>
                <Text style={{ color: textSecondary, fontSize: 11, fontWeight: "600" }}>🌎 Public</Text>
              </View>
            </View>
          </View>
        </View>
