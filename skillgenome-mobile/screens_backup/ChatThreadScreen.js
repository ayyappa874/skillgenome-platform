  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.title}>{conversation?.name || t(language, "chat")}</Text>
        <Pressable
          style={styles.moreButton}
          onPress={() =>
            Alert.alert(t(language, "threadOptions"), "What do you want to do?", [
              { text: t(language, "cancel"), style: "cancel" },
              {
                text: t(language, "deleteChat"),
                style: "destructive",
                onPress: () => {
      ...
      <Text style={styles.today}>{t(language, "today")}</Text>
      ...
      <View style={styles.composerRow}>
        <Pressable style={styles.attachButton} onPress={() => Alert.alert("Attach", "Attachment action is ready.")}> 
          <Text style={styles.attachIcon}>📎</Text>
        </Pressable>

        <TextInput
          style={styles.input}
          placeholder={t(language, "textMessagePlaceholder")}
          placeholderTextColor={isDarkMode ? Color.colorBlue42 : "#64748b"}
          value={message}
          onChangeText={setMessage}
        />

        <Pressable style={styles.emojiButton} onPress={() => Alert.alert("Emoji", "Emoji picker can be wired here.")}> 
