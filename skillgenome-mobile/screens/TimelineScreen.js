...
// ── Progress Bar ──
const ProgressBar = ({ value, color, height = 4, S, T }) => {
...
const TimelineScreen = ({
  ...
  const thoScore = hasTho ? (thoughtAnalysis?.overall_score || 82) : 0;
      ...
      <ScrollView contentContainerStyle={S.content} showsVerticalScrollIndicator={false}>
        <Animated.View style={{ opacity: fade, transform: [{ translateY: slide }], gap: 20 }}>
          ...
          <View style={[S.card, { borderColor: T.border }]}>
            ...
            <ProgressBar value={(activeCount / 4) * 100} color={T.accent} height={6} S={S} T={T} />
