  ...
  React.useEffect(() => {
    ...
    const fetchGit = async () => {
      ...
      try {
        ...
        setData({ username, score: finalScore, totalRepos: userData.public_repos || reposData.length, languages: langs.length ? langs : ["JavaScript"], repos });
      } catch (e) {
            ...
            <View style={[S.heroCard, { borderColor: T.border }]}>
              ...
              <View style={S.scoreWrap}>
                ...
                <View style={{ flexDirection: "row", alignItems: "center", gap: 12 }}>
                  <View style={[S.statRing, { borderColor: T.cyan }]}>
                    <Text style={S.statNum}>{data.totalRepos}</Text>
...
const getStyles = (T) => StyleSheet.create({
  ...
  statRing: { width: 56, height: 56, borderRadius: 28, borderWidth: 2, alignItems: "center", justifyContent: "center", opacity: 0.9 },
  statNum: { fontSize: 18, fontWeight: "800", color: T.text },
  statLabel: { fontSize: 8, fontWeight: "800", color: T.muted, letterSpacing: 0.5, marginTop: -2 },
