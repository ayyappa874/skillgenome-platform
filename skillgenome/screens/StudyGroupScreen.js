...
const StudyGroupScreen = ({ onBack, connections: connectionsProp, onSendInvites, onDeleteChat, onSendMessage, studyGroup, setStudyGroup, studyGroupMessages, setStudyGroupMessages, isDarkMode = true, language = 'English' }) => {
