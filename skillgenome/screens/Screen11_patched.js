...
import { Alert, ScrollView, Text, StyleSheet, View, Image, Pressable, TextInput, FlatList, Animated, Dimensions, Easing, RefreshControl } from "react-native";
...
const AnimatedPressable = ({ children, style, onPress, ...props, isDarkMode = true, language = 'English' }) => {
  ...
  return (
    <View style={[styles.root, { backgroundColor: bgStyle }]}>
      ...
      <View style={StyleSheet.absoluteFill}>
         <View style={{ position: 'absolute', top: -100, left: -100, width: 300, height: 300, borderRadius: 150, backgroundColor: isDarkMode ? 'rgba(0, 212, 255, 0.15)' : 'rgba(0, 212, 255, 0.2)' }} />
         <View style={{ position: 'absolute', top: 300, right: -150, width: 350, height: 350, borderRadius: 175, backgroundColor: isDarkMode ? 'rgba(139, 92, 246, 0.15)' : 'rgba(139, 92, 246, 0.2)' }} />
         <View style={{ position: 'absolute', bottom: -50, left: 50, width: 250, height: 250, borderRadius: 125, backgroundColor: isDarkMode ? 'rgba(233, 30, 99, 0.1)' : 'rgba(233, 30, 99, 0.15)' }} />
      </View>
      ...
      <ScrollView
        ...
        refreshControl={
          <RefreshControl
            ...
            onRefresh={onRefresh}
            tintColor={isDarkMode ? Color.colorAzure65 : Color.colorBlue19}
            colors={[Color.colorAzure65, Color.colorRose60]}
          />
        }
      >
        <View style={styles.container}>
          ...
          <View style={[styles.scoreCard, { backgroundColor: cardBg, borderColor: borderStyle }]}>
            ...
            <View style={styles.scoreInner}>
              <View style={[styles.scoreBadge, { backgroundColor: scoreInnerBg, borderColor: borderStyle }]}>
            ...
            <View style={[styles.insightCard, { backgroundColor: cardBg, borderColor: borderStyle }]}>
              <View style={styles.insightHeader}>
                ...
                <View style={[styles.insightScoreBadge, { borderColor: Color.colorCyan50, borderWidth: 1 }]}>
                  <Text style={[styles.insightScoreText, { color: Color.colorCyan50 }]}>
                    Score: {thoughtAnalysis.overall_score}/100
                  </Text>
                </View>
              </View>
              ...
              <View style={styles.metricsGrid}>
                <View style={[styles.metricItem, { backgroundColor: isDarkMode ? "rgba(255, 255, 255, 0.01)" : "rgba(0,0,0,0.02)", borderColor: isDarkMode ? "rgba(255, 255, 255, 0.04)" : "rgba(0,0,0,0.08)" }]}>
                  ...
                  <Text style={[styles.metricValue, { color: textPrimary }]}>{thoughtAnalysis.cognitive_style || "N/A"}</Text>
                </View>
                <View style={[styles.metricItem, { backgroundColor: isDarkMode ? "rgba(255, 255, 255, 0.01)" : "rgba(0,0,0,0.02)", borderColor: isDarkMode ? "rgba(255, 255, 255, 0.04)" : "rgba(0,0,0,0.08)" }]}>
                  <Text style={[styles.metricLabel, { color: textSecondary }]}>Stress Level</Text>
                  <Text style={[styles.metricValue, { color: thoughtAnalysis.stress_score > 65 ? "#E94B4B" : "#4CAF50" }]}>
                    {thoughtAnalysis.stress_score}%
                  </Text>
                </View>
                <View style={[styles.metricItem, { backgroundColor: isDarkMode ? "rgba(255, 255, 255, 0.01)" : "rgba(0,0,0,0.02)", borderColor: isDarkMode ? "rgba(255, 255, 255, 0.04)" : "rgba(0,0,0,0.08)" }]}>
                  <Text style={[styles.metricLabel, { color: textSecondary }]}>Valence/Sentiment</Text>
                  <Text style={[styles.metricValue, { color: textPrimary }]}>{thoughtAnalysis.positive_sentiment}% Pos</Text>
                </View>
              </View>
              ...
              <View style={styles.insightHeader}>
                ...
                <View style={[styles.insightScoreBadge, { borderColor: "#8B5CF6", borderWidth: 1 }]}>
                  <Text style={[styles.insightScoreText, { color: "#8B5CF6" }]}>
                    EQ Score: {emotionAnalysis.eq_score}/100
                  </Text>
                </View>
              </View>
              <Text style={[styles.insightSubtitle, { color: textSecondary }]}>
      ...
      <View style={[styles.bottomNav, { backgroundColor: bottomNavBg, borderTopColor: borderStyle }]}>
        <Pressable
